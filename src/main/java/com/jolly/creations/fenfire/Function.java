...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "b466ffc25add62e68de7c3c4ccb1bcf9";
    ...
    public static class placeIdTask extends AsyncTask<String, Void, JSONObject> {
        ...
        public AsyncResponse delegate = null;//Call backminimalist interface

        public placeIdTask(AsyncResponse asyncResponse) {
            delegate = asyncResponse;//Assigning call backminimalist interfacethrough constructor
        }
